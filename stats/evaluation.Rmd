...
for (title in description_vars){
  ...
  ggsave(sprintf("plots/%s_vs_%s.png",title,title_comp), plot = pairs)
  saveWidget(ggplotly(pairs), file = sprintf("interactive/%s_vs_%s.html",title,title_comp));
  }
}
